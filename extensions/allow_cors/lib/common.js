...
app.options.receive("patch", function (e) {
    config.cors.patch = e
});
app.options.receive("origin", function (e) {
    config.cors.origin = e
});
app.options.receive("methods", function (e) {
    config.cors.methods = e
});
app.options.receive("headers", function (e) {
    config.cors.headers = e
});
app.options.receive("sub_frame", function (e) {
    config.cors.sub_frame = e
});
app.options.receive("whitelist", function (e) {
    config.addon.whitelist = e
});
app.options.receive("main_frame", function (e) {
    config.cors.main_frame = e
});
app.options.receive("credentials", function (e) {
    config.cors.credentials = e
});
app.options.receive("domain_type", function (e) {
    config.cors.domain_type = e
});
...
app.popup.receive("reload", function () {
    app.tab.reload(null, true)
});
app.popup.receive("support", function () {
    app.tab.open(app.homepage())
});
app.popup.receive("test", function () {
    app.tab.open(config.addon.page.test)
});
app.popup.receive("tutorial", function () {
    app.tab.open(config.addon.page.tutorial)
});
